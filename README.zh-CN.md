...
[![Platform API](https://img.shields.io/badge/探索-Platform_API-00AEEF?logo=fastapi&logoColor=white)](https://docs.ultralytics.com/zh/platform/api)
...
> [!IMPORTANT]
> Ultralytics HUB 和 HUB-SDK 已于 2026 年 7 月 31 日关闭。在此之前，托管的 HUB 到 Platform 迁移已于 2026 年第二季度顺利完成。此 SDK 已停止维护，无法连接 Platform；旧版 HUB API key 也已停止工作。请使用 [Platform REST API](https://docs.ultralytics.com/zh/platform/api)构建新的集成。
...
## 🔌 使用 Platform API 实现自动化

创建 workspace-scoped API key，并使用当前 REST API 管理数据集、项目、模型、训练、导出与部署。[Platform API 文档](https://docs.ultralytics.com/zh/platform/api)是所有 endpoint 的权威参考。
...
Ultralytics 提供 [AGPL-3.0](LICENSE) 和[企业许可证](https://www.ultralytics.com/license)，分别适用于开源和商业用途。

## 🤝 社区

如需当前产品帮助或提交反馈，请使用 Platform 内的 **Help** 页面、浏览 [Platform 文档](https://docs.ultralytics.com/zh/platform)，或加入 [Ultralytics 社区](https://community.ultralytics.com/)。本仓库仅作为 HUB-SDK 的历史参考保留。
