...
# credentials = {"api_key": "99f3febd63071ad6c2d7fd17c1886cb01d8bded8ac"}
# credentials = {"email": "rick.sanchez@citadel.com", "password": "987654321"}
...
# model.upload_model(is_best= True, epoch=5, weights="example.pt")
